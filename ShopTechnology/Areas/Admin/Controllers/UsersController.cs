...
public class UsersController : Controller
{
    ...
    public async Task<IActionResult> Create(User user)
    {
        try
        {
            if (ModelState.IsValid)
            {
                ...
                // user.IsActive = true - removed because User model doesn't have IsActive property
    ...
    public async Task<IActionResult> Edit(int id, User user)
    {
        try
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // existingUser.RoleId = user.RoleId - removed because User model doesn't have RoleId property
                // existingUser.IsActive = user.IsActive - removed because User model doesn't have IsActive property
    ...
    public async Task<IActionResult> ToggleActive(int userId)
    {
        try
        {
            ...
            // user.IsActive = !user.IsActive - removed because User model doesn't have IsActive property
            ...
            {
                success = true,
                message = true /* user.IsActive - removed because User model doesn't have IsActive property */ ? "Người dùng đã được kích hoạt" : "Người dùng đã bị khóa",
                isActive = true /* user.IsActive - removed because User model doesn't have IsActive property */
            });
        }
        catch (Exception ex)
        {
    ...
    public async Task<IActionResult> ChangeRole(int userId, int roleId)
    {
        try
        {
            ...
            // Remove existing user roles and add new one
